  ...
  switch (this.obj.type) {
    ...
    case 'ZHASwitch':
      if (
        ...
        // Xiaomi Aqara Opple (Triple Rocker/Six Buttons)
        this.createLabel(Characteristic.ServiceLabelNamespace.ARABIC_NUMERALS)
        this.createButton(1, 'Top-Left', SINGLE_DOUBLE_LONG)
        this.createButton(2, 'Top-Right', SINGLE_DOUBLE_LONG)
        this.createButton(3, 'Middle-Left', SINGLE_DOUBLE_LONG)
        this.createButton(4, 'Middle-Right', SINGLE_DOUBLE_LONG)
        this.createButton(5, 'Bottom-Left', SINGLE_DOUBLE_LONG)
        this.createButton(6, 'Bottom-Right', SINGLE_DOUBLE_LONG)
        this.type = {
          key: 'buttonevent',
          homekitValue: function (v) { return Math.floor(v / 1000) },
          homekitAction: hkZLLSwitchAction
